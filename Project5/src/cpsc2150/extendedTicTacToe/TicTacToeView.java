 ...
 * the buttons will be arranged in a ROWS_IN_BUTTON_PANEL x COLUMNS_IN_BUTTON_PANEL Grid
...
public final class TicTacToeView extends JFrame implements ActionListener {
    ...
    private float fontInButtonsSize = 30;
    ...
    public TicTacToeView(int row, int col)
    {
        ...
        //create the widgets
        this.message = new JTextArea("It's player X's turn...", LINES_IN_TEXT, LINE_TEXT_LENGTHS);
        //read only
        ...
        for(int i=0; i < ROWS_IN_BUTTON_PANEL * COLUMNS_IN_BUTTON_PANEL; i++)
        {
            ...
            button.setFont(message.getFont().deriveFont(fontInButtonsSize));
            buttons.add(button);
